...
**Loading (interactive viewer):** The HTML loads two scripts: `config.generated.js` (classic script, sets `window.EyecatcherConfig`) then `app.js` (ES module entry). All other modules are loaded via the dependency graph from `app.js`.
