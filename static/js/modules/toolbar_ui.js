...
(function () {
    ...
    function initStartFreshDropdown() {
        ...
        menu.querySelectorAll('[data-action]').forEach(function (item) {
            item.addEventListener('click', function () {
                if (item.dataset.action === 'random') window.PopulationUI.startNewRandomPopulation();
                else if (item.dataset.action === 'load') window.PopulationUI.onLoadSavedClick();
                close();
            });
    ...
    function initHelpToggle() {
        ...
        helpBtn.addEventListener('click', function () {
            ...
            helpBtn.setAttribute('title', instructions.hidden ? 'Show help' : 'Hide help');
        });
