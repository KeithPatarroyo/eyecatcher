...
(function () {
    ...
    const ZoomSignals = {
        ...
        init: function () {
            ...
            // Effects: Mouse Ripple toggle
            var mouseRippleCheckbox = document.getElementById('effect-mouseRipple');
            if (mouseRippleCheckbox) {
                mouseRippleCheckbox.addEventListener('change', function (e) {
                    self.signalState.effects.mouseRipple = e.target.checked;
                });
            }
        }
    };
