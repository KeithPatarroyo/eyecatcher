...
Main API for evolution (CPPNEngine, DualGenome, serialization, ShaderCompiler):
use ``from eyecatcher.evolution import ...``. Entrypoint for the web app:
``eyecatcher.server:app``.
"""
