...
Used only by DualCPPNSubstrate. Generic NEAT genome types live in genome/.
"""
...
def copy_dual_genome(
    ...
    from ..genome.serialization import copy_genome
...
def mutate_dual_genome(
    ...
    from ..algorithm.operators import mutate_genome
...
def crossover_dual_genomes(
    ...
    from ..algorithm.operators import crossover_genomes
